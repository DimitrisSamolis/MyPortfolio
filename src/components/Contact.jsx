            ...
            <div className='pb-8 rounded-2xl p-6 bg-gradient-to-b from-blue-800 to-transparent'>
                ...
                <div className='flex justify-center items-center'>
                    <form action='https://getform.io/f/003c2f84-ce2c-4853-9636-7dd4bb8ae134' method='POST' className='flex flex-col w-full md:w-1/2'>
                        ...
                        className='p-4 bg-transparent rounded-md border-2  focus:outline-none' ></textarea>
                        <button className=' rounded-md bg-gradient-to-r  from-yellow-400 to to-orange-600 
                            px-6 py-3 my-8 mx-auto flex items-center hover:scale-110 duration-300'> Send!
                        </button>
                    </form>
                </div>
            </div>
