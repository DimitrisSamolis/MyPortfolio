...
const Experience = () => {
    ...
    const techs = [
        ...
        { id:8,src: tailwind, title:'TailwindCss', style: 'shadow-sky-300' },
        { id:9,src: angular, title:'Angular', style: 'shadow-red-700' },

    ]

  return (
    <div name='Experience' className='w-full py-40 md:px-8  '>
        <div className='maw-w-screen-lg mx-auto p-4 flex flex-col justify-center w-full h-full text-white my-20'> 
            <div className="rounded-2xl p-6 bg-gradient-to-b from-blue-800 to-transparent" >
                ...
                <div className=' grid grid-cols-2 md:grid-cols-3 gap-8 text-center py-8 px-8 sm:px-4'>
                    {techs.map(({id,src,title,style}) => (
                            <div key={id} className={`shadow-md hover:scale-105 duration-500 py-2 rounded-3xl bg-gradient-to-b from-gray-700 to-transparent ${style}`}>
