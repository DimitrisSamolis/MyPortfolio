      ...
      <div className="max-w-screen-lg  mx-auto flex items-center justify-center mt-20 p-4 md:flex-row ">
        <div className="rounded-2xl p-6 w-auto h-auto flex items-center justify-center bg-gradient-to-b from-blue-800 to-transparent">
            <div className="flex flex-col justify-center h-full px-6 ">
              ...
              <div>
                <Link to='Portfolio' smooth duration={500} className='group text-white w-fit px-4 py-3 my-3 flex items-center rounded-md bg-gradient-to-r from-yellow-400 to to-orange-600 cursor-pointer'>
                  My Projects  
          ...
          <div className="my-4 ">
            <img src={MyImage} alt="my profile" className="rounded-full max-w-md h-auto md:w-32 w-24 text-right justify-between" />
          </div>
        </div>
      </div>
    </div>  
