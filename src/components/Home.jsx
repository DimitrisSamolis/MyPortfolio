  ...
  return (
    <div name="Home" className=" w-full py-20 md:mb-0">
      <div className="max-w-screen-lg  mx-auto flex items-center justify-center mt-20 sm:mt-24 p-4 md:flex-row ">
        <div className={`rounded-2xl p-6 w-auto h-auto flex items-center justify-center bg-lightblue `}>
            <div className="flex flex-col justify-center h-full px-2 sm:px-6 font-semi">
              ...
              <div>
                <Link to='Projects' smooth duration={500} className='group w-fit p-2 my-3 flex items-center rounded-xl bg-brown cursor-pointer'>
                  My Projects  
          ...
          <div className="my-4 ">
            <img src={MyImage} alt="my profile" className="shadow-2xl shadow-black rounded-3xl max-w-md h-auto md:w-32 w-24 text-right justify-between" />
          </div>
        </div>
      </div>
